...
const EditSanPham = ({ setShowEditSanPham, product }) => {
  ...
  useEffect(() => {
    axios
      .get("https://restaurant-manager-be-1.onrender.com/api/categories")
      .then((response) => {
      ...
      <form className="popup-container" onSubmit={handleSubmit}>
        ...
        <div className="popup-table">
          <div className="popup-inputs">
            <div
              className={`popup-input ${errors.tenMonAn ? "errorClass" : ""}`}
            >
            ...
            <div
              className={`popup-input ${errors.loaiMonAn ? "errorClass" : ""}`}
            >
            ...
            <div
              className={`popup-input ${errors.trangThai ? "errorClass" : ""}`}
            >
          ...
          <div className={`popup-inputs ${errors.moTa ? "errorClass" : ""}`}>
